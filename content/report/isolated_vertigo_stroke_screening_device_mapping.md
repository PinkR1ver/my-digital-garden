---
title: 孤立性眩晕卒中筛查：专业设备能力与低成本视频眼动简化路径
tags:
  - report
  - vertigo
  - nystagmus
...
专业前庭检查不是单一设备完成的单一动作，而是一组围绕“眼动反应”和“前庭刺激反应”的检查组合。它的思路很清楚：先把眼震有没有、方向是否异常、眼动控制是否稳定这些可见线索记录下来，再通过头脉冲、冷热试验、转椅等项目进一步评估外周前庭功能和头眼反射。Interacoustics 等专业系统通常会把这些项目组合成完整检查流程。[^visualeyes][^eyeseecam]
...
这方面并不缺少临床框架。过去十几年里，急诊和神经耳科已经提出了多套面向急性眩晕/急性前庭综合征的快速分诊方法，包括 HINTS / HINTS+、STANDING、TiTrATE、GRACE-3 指南框架，以及更新的 SAV3E 预测模型。它们的共同点是：不把眩晕简单当成“头晕”来问，而是把病程、诱因、眼震方向、头脉冲、步态、听力和血管风险因素组合起来判断中枢风险。[^hints][^standing][^plos_standing][^grace3][^sav3e]
...
![](report/attachments/nystagmus_video_capture_two_modes_headworn.png)

*图：眼震视频采集的两种核心形态：居家自测/外置摄像头模式，以及基层诊间/医生采集模式。*

![](report/attachments/magnetic_clip_shade_phone_mount.png)

*图：手机端磁吸夹具与遮光罩方案*

![](report/attachments/home_nystagmus_principle.png)
...
<figure>
  <div style="display: flex; gap: 12px; align-items: flex-start;">
    <img src="report/attachments/IMG_4979.PNG" alt="Home Nystagmus Monitor 采集界面" style="width: 49%; object-fit: contain;" />
    <img src="report/attachments/IMG_4978.PNG" alt="Home Nystagmus Monitor 分析结果界面" style="width: 49%; object-fit: contain;" />
  </div>
  <figcaption>图：采集入口和分析结果界面。</figcaption>
</figure>
...
[^hints]: Kattah et al., [HINTS to diagnose stroke in the acute vestibular syndrome](https://www.ahajournals.org/doi/10.1161/strokeaha.109.551234), *Stroke*, 2009.
[^hints_review]: Cochrane-style review protocol/background, [Head impulse, nystagmus, and test of skew examination for diagnosing central causes of acute vestibular syndrome](https://pmc.ncbi.nlm.nih.gov/articles/PMC9361284/).
[^vhit]: Interacoustics, [Video Head Impulse Test (vHIT): A Deep Dive](https://www.interacoustics.com/academy/balance-testing-training/video-head-impulse-test/video-head-impulse-test-deep-dive).
[^standing]: Vanni et al., [STANDING, a four-step bedside algorithm for differential diagnosis of acute vertigo in the Emergency Department](https://pmc.ncbi.nlm.nih.gov/articles/PMC4346998/).
[^plos_standing]: Nakatsuka and Molloy, [The HINTS examination and STANDING algorithm in acute vestibular syndrome](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0266252), *PLOS ONE*, 2022.
[^grace3]: SAEM, [GRACE-3: Acute Dizziness and Vertigo in the Emergency Department](https://www.saem.org/publications/grace/grace-3).
[^sav3e]: Guo et al., [Prediction Model for Etiologic Differentiation of Isolated Vestibular Syndrome in Emergency Settings](https://onlinelibrary.wiley.com/doi/10.1002/acn3.70213), *Annals of Clinical and Translational Neurology*, 2025.
