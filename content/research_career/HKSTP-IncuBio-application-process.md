---
title: HKSTP Incu-Bio 申请流程与材料准备
date: 2026-07-13
tags:
  - research
  - startup
...
flowchart TD
    ...
    C -- 否 --> C1[暂缓申请并补足条件]
    C1 --> B
    C -- 是 --> D[申请人｜3. PartnersConnect 注册及公司资料建立]
    D --> E[申请人｜4. 准备并提交完整申请包]
    E --> F[HKSTP｜5. 收件确认]
    F --> G[HKSTP｜6. 完整性及资格审查]
    G --> H{需要补件或澄清?}
    H -- 是 --> I[申请人｜7. 补件及回复澄清]
    I --> J{超过两个月仍未提交?}
    J -- 是 --> J1[申请可能被视为撤回]
    J -- 否 --> G
    H -- 否 --> K[申请人 + Panel｜8. 汇报及评审]
    K --> L{Panel 要求修改?}
    L -- 是 --> M[申请人｜9. 修订并提交最终申请文件]
    M --> N[HKSTP｜10. 审批结果]
    L -- 否 --> N
    N --> O{获批?}
    O -- 否 --> O1[申请结束／评估是否重新申请]
    O -- 是 --> P[双方｜11. 签署协议及入驻]
    P --> Q[进入四年 Incu-Bio 培育期]
```
